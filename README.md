...
This independently maintained derivative is published from
[`joeroberts/terraform-aws-rds-aurora`](https://github.com/joeroberts/terraform-aws-rds-aurora)
as release `v10.2.0-neutral.1`. See [UPSTREAM.md](UPSTREAM.md) for provenance.
...
```hcl
module "cluster" {
  source = "git::https://github.com/joeroberts/terraform-aws-rds-aurora.git?ref=v10.2.0-neutral.1"
...
- [Autoscaling](https://github.com/joeroberts/terraform-aws-rds-aurora/tree/v10.2.0-neutral.1/examples/autoscaling): A PostgreSQL cluster with enhanced monitoring and autoscaling enabled
- [DSQL](https://github.com/joeroberts/terraform-aws-rds-aurora/tree/v10.2.0-neutral.1/examples/dsql): Multi region and single region DSQL clusters
- [Global Cluster](https://github.com/joeroberts/terraform-aws-rds-aurora/tree/v10.2.0-neutral.1/examples/global-cluster): A PostgreSQL global cluster with clusters provisioned in two different region
- [Limitless](https://github.com/joeroberts/terraform-aws-rds-aurora/tree/v10.2.0-neutral.1/examples/limitless): A PostgreSQL Limitless cluster
- [Multi-AZ](https://github.com/joeroberts/terraform-aws-rds-aurora/tree/v10.2.0-neutral.1/examples/multi-az): A multi-AZ RDS cluster (not using Aurora engine)
- [MySQL](https://github.com/joeroberts/terraform-aws-rds-aurora/tree/v10.2.0-neutral.1/examples/mysql): A simple MySQL cluster
- [PostgreSQL](https://github.com/joeroberts/terraform-aws-rds-aurora/tree/v10.2.0-neutral.1/examples/postgresql): A simple PostgreSQL cluster
- [S3 Import](https://github.com/joeroberts/terraform-aws-rds-aurora/tree/v10.2.0-neutral.1/examples/s3-import): A MySQL cluster created from a Percona Xtrabackup stored in S3
- [Serverless](https://github.com/joeroberts/terraform-aws-rds-aurora/tree/v10.2.0-neutral.1/examples/serverless): Serverless V1 and V2 (PostgreSQL and MySQL)
...
This derivative is maintained at [`joeroberts/terraform-aws-rds-aurora`](https://github.com/joeroberts/terraform-aws-rds-aurora). Upstream authorship and [contributor credit](https://github.com/terraform-aws-modules/terraform-aws-rds-aurora/graphs/contributors) are preserved.

## License

Apache 2 Licensed. See [LICENSE](https://github.com/joeroberts/terraform-aws-rds-aurora/blob/v10.2.0-neutral.1/LICENSE) for full details.
